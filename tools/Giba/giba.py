...
def analyze_all_pretty(mod, threshold, toanali,refatom):
        for j in toanali:
                ...
                if j!="d_": #analysis for plane width and height
                        ...
                        print("minima for positive current found at", smallest, end=' ')
                        print("This will be written to gimic.inp")
...
print() 
print("For all the procedures in this program, a gimic.inp file", end=' ')
...
if options.rundistances:
        ...
        if status.any():
                print("The magnetic field has been set so it is perpendicular to the bond in study", end=' ')
                print("(first two parameters) but paralell to the plane of the molecule as defined ", end=' ')
...
#to make it work with  sbatch job system.
        ...
        print("The bond distance, plane size and field angle have been optimized. For extra safety", end=' ') 
